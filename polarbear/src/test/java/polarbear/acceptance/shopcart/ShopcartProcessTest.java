...
public class ShopcartProcessTest {
    ...
    public void test4ShouldReturnMyShopcartDataWhenModifyProductNumAndUserLogined() {
        new ModifyProductNumTest().shouldReturnMyShopcartDataWhenModifyProductNumAndUserLogined(shopcartDataList, buyProduct1);
    }

    @Test
    public void test5ShouldReturnMyShopcartDataWhenModifyProductNumAndUserLogined() {

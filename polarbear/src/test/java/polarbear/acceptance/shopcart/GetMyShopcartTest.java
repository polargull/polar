    ...
    public void shouldReturnMyShopcartDataWhenQueryShopcartAndUserLogined() {
        ...
        .post(new ResultCallback() {
            public void onSuccess(JsonResult jsonResult) throws UnsupportedEncodingException {
                ...
                assertThat(shopcart.getProductNum(), equalTo(8));
                assertThat(shopcart.getTotalPrice(), equalTo(createProduct1().getRealPrice() * 2 + createProduct2().getRealPrice() * 3 + createSalePrice6Product3().getRealPrice() * 3));

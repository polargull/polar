...
import polarbear.acceptance.login.LoginSynchShopcartDataTest;
...
@RunWith(Suite.class)
@Suite.SuiteClasses( { LoginTest.class, LoginSynchShopcartDataTest.class, RegistTestSuite.class, ShopcartTestSuite.class, ProductTestSuite.class, AcceptanceBackTestSuite.class,
        BalanceTest.class })

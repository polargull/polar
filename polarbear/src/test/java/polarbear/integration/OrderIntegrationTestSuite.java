...
import polarbear.integration.service.order.GetOrderDetailServiceTest;
...
@RunWith(Suite.class)
@Suite.SuiteClasses( { CreateOrderServiceTest.class, CancleOrderServiceTest.class, PayOrderServiceTest.class, SignOrderServiceTest.class, DeliveryOrderServiceTest.class, GetOrderDetailServiceTest.class })
